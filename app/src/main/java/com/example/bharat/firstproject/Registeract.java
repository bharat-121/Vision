...
//start register_user activity
    ...
    // [START basic_write]
    private void writeNewUser(String userId, String username, String name, String email) {
        UserInformation user = new UserInformation(username, name, email);
